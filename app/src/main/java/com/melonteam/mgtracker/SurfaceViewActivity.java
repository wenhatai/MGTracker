            ...
            public void run() {
                ...
                while (currentData != null){
                    ...
                    synchronized (isInitTrack) {
                        ...
                        if (!isInitTrack) {
                            MGTracker.newInstance().openTrack(currentData, MGTracker.TYPE_NV21,(int) rectF.left, (int) rectF.top, (int) rectF.width(), (int) rectF.height(), mCameraWidth, mCameraHeight);
                            isInitTrack = true;
                            android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_MORE_FAVORABLE);
                        } else {
                            int[] cmtData = MGTracker.newInstance().processTrack(currentData, MGTracker.TYPE_NV21,mCameraWidth, mCameraHeight);
                            if(cmtData != null){
