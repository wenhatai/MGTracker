    ...
    public static class MainRenderer implements Renderer, SurfaceTexture.OnFrameAvailableListener,Camera.PreviewCallback{
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            synchronized (isInitTrack) {
                ...
                if (!isInitTrack) {
                    ObjTrack.newInstance().openTrack(data, ObjTrack.TYPE_NV21,(int) rectF.left, (int) rectF.top, (int) rectF.width(), (int) rectF.height(), mCameraWidth, mCameraHeight);
                    isInitTrack = true;
                } else {
                    int[] cmtData = ObjTrack.newInstance().processTrack(data,ObjTrack.TYPE_NV21,mCameraWidth, mCameraHeight);
                    if(cmtData != null){
